...
public class btCollisionObject extends BulletBase implements com.badlogic.gdx.utils.Disposable {
	...
	public btCollisionObject (btTransform worldTransformBuffer) {
		this(CollisionJNI.new_btCollisionObject__SWIG_0(btTransform.getCPtr(worldTransformBuffer), worldTransformBuffer), true);
	}

	public btCollisionObject () {
		this(CollisionJNI.new_btCollisionObject__SWIG_1(), true);
	}
	...
	public java.nio.ByteBuffer getWorldTransformBuffer () {
