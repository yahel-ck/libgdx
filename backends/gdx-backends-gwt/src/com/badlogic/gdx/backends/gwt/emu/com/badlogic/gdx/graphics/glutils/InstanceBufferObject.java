...
public class InstanceBufferObject implements InstanceData {
	...
	public void bind (ShaderProgram shader, int[] locations) {
		...
		if (locations == null) {
			for (int i = 0; i < numAttributes; i++) {
				...
				if (location >= 0) bindVertexAttribute(shader, attribute, location);
			}
	...
	private void bindVertexAttribute (ShaderProgram shader, final VertexAttribute attribute, int location) {
	...
	@Override
	public void unbind (final ShaderProgram shader, int[] locations) {
		final GL20 gl = Gdx.gl20;
		final int numAttributes = attributes.size();
		if (locations == null) {
			for (int i = 0; i < numAttributes; i++) {
